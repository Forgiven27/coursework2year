...
class SecondTabUI(object):
    def setupUi(self, QWidget):
        ...
        self.graph_phase_neg.setData([0, 1, 2, 3, 4, 5, 6, 7], [2, 3, 2, 3, 4, 2, 4, 2], pen=pyqtgraph.mkPen(color=(255, 0, 0)))

        self.graph_phase_neu = graph_phase.plot(name="\u03B1(\u03BC)")
        self.graph_phase_neu.setData([0, 1, 2, 3, 4, 5, 6, 7], [1, 5, 3, 3, 4, 3, 5, 1], pen=pyqtgraph.mkPen(color=(0, 255, 0)))

        self.graph_phase_pos = graph_phase.plot(name="\u03B1(\u03BC)+")
        self.graph_phase_pos.setData([0, 1, 2, 3, 4, 5, 6, 7], [3, 2, 1, 3, 2, 1, 3, 2], pen=pyqtgraph.mkPen(color=(0, 0, 255)))
